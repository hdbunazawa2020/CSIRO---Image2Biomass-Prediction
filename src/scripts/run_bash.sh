...
# SCRIPT_PATH="$PROJECT_ROOT/src/scripts/102_train_aux_regressor/102_train_aux_regressor.py"
SCRIPT_PATH="$PROJECT_ROOT/src/scripts/103_train_splitcrop_aux_regressor/103_train_splitcrop_aux_regressor.py"
NUM_GPUS=2
